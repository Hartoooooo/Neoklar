...
void main(){gl_Position=position;}`;
  ...
  const resize = () => {
    ...
    // Nutze die volle Viewport-Breite
    canvas.width = window.innerWidth * dpr;
    canvas.height = window.innerHeight * dpr;
    
    // Stelle sicher, dass das Canvas die volle Breite einnimmt
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        {trustBadge && (
          <div className="mb-8 animate-fade-in-down">
            <div className="flex items-center gap-2 px-6 py-3 bg-cyan-500/10 backdrop-blur-md border border-slate-200 border-cyan-300/30 rounded-full text-sm dark:border-slate-800">
              {trustBadge.icons && (
                <div className="flex">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-in-up animation-delay-800">
              ...
              {buttons.secondary && (
                <button 
                  ...
                  className="px-8 py-4 bg-cyan-500/10 hover:bg-cyan-500/20 border border-slate-200 border-cyan-300/30 hover:border-cyan-300/50 text-cyan-100 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm dark:border-slate-800"
                >
